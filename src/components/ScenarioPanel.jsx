...
export default function ScenarioPanel({ scenario, phase2State, onStart, onComplete }) {
  ...
  return (
    <div className="w-full xl:w-[350px] xl:shrink-0 border-b xl:border-b-0 xl:border-r border-themed bg-surface flex flex-col overflow-visible xl:overflow-y-auto">
