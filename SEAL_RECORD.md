...
### 本次变更摘要
- 新增基础教程前置筛选闸门：模块 00/01/02 进入前需完成学历、专业、工作经验评估。
- 筛选规则支持硬门槛 + 加减分：未满足“全日制大专及以上”直接不通过，其余按维度累计评分并与阈值比对。
- 筛选结果本地持久化，达标后可直接进入基础教程；不达标时拦截并提示“暂不满足学习条件”。
- `todolist.md` 新增页面安全防护规划项（防复制、防抓取、动态水印与接口防护）。

### 关键文件 SHA-256
| 文件 | SHA-256 |
|------|---------|
| `package.json` | `a8613af40612ff689f08660b9800f21d467ccaaf073bfbecba661956a7c8a29a` |
| `package-lock.json` | `a31daee79ba88aced5f708d04bb9bb282e34349589b789ba447b153231cbf27a` |
| `src/App.jsx` | `52ad74ec818d4bf63bf389d6caad60046b919eec4d868265efb54adec38b58cd` |
| `todolist.md` | `a479eb006573f3dc320924ea97998f39f47121cf18439357ac578808926dfd62` |

### 说明
- 本次封板聚焦“基础教程准入筛选 + 安全防护待办沉淀”，未改动教程内容模块数据结构。

---

## v1.1.7 — 2026-05-19（已归档）
...
### 本次变更摘要
- 全项目术语统一为“教程”：前端界面、后端提示、数据文案与项目文档完成替换。
- 模块 00 文件重命名为 `00_教程介绍与学习说明.md`，并完成数据映射同步。
- 移动端导航新增自动收缩机制：默认展示后数秒折叠为右下角悬浮按钮，点击可展开。
- 自动收缩逻辑对齐总览页与模块页，减少遮挡同时保留快速入口。

### 关键文件 SHA-256
| 文件 | SHA-256 |
|------|---------|
| `package.json` | `7718738c20ec1b0441976936ee7e40f0b690ddefd6693a12252cc4ef10bdb017` |
| `package-lock.json` | `6f2a8710fb182b4a24a1c573ccf8fb0db24f3d98fb54d14f8cdce1edbe71abca` |
| `src/components/WorkbenchSidebar.jsx` | `a3b473731d5ce82bfe221b541cbcd36fc49072192620009ce0340f4f27747701` |
| `src/index.css` | `d5e1ef8cdf49a5152f205a5b7b1568278bb15faa3df59a4647688f080027bef3` |
| `src/data/modules.js` | `da94493ebee95b16a7e3ac56a01648f63063df6692b6c1ea502e3e412c507374` |
| `public/content/00_教程介绍与学习说明.md` | `3c49c9660ac535b0a87d38caf62d305e64f038352affddc96e1fa83b8f11eab8` |

### 说明
- 本次封板同时包含“移动端导航交互优化 + 教程术语统一”，已通过构建与内容校验闸门。

---

## v1.1.6 — 2026-05-19（已归档）
...
### 本次变更摘要
- 移动端教程页底部导航改为右下角紧凑悬浮模式，避免全宽导航长期遮挡正文。
- 导航策略按视图切换：总览页保留全宽底部导航，模块学习页自动切换为紧凑导航。
- 抽屉层与底部入口联动保持一致：抽屉打开时隐藏入口并锁定滚动，避免层叠遮挡。
- 调整移动端主内容底部占位，减少无效留白并提升阅读连续性。

### 关键文件 SHA-256
| 文件 | SHA-256 |
|------|---------|
| `package.json` | `bb79ab7e93654e043b457c616956f6b90a7657338e29c894c7e36871d6572a44` |
| `package-lock.json` | `26d4b265187524bcb05cb9871bfee504674be4900040068656c1c3d3684a6875` |
| `src/App.jsx` | `e99cff15fdb29f3aa9d28afdddf7f8be84d08a1adfff1a801116a4781e625b0e` |
| `src/components/WorkbenchSidebar.jsx` | `641c20fb668833acbed97b688f0f94dcdce4d7643331ca410ea9c81913c7e155` |
| `src/index.css` | `98acb587892fad9bee24a2778ade3bab5ccd33b4ac0c1a5c39095987d8e1b81d` |

### 说明
- 本次封板聚焦移动端教程页阅读体验与导航遮挡治理，未改动教程内容数据结构。

---

## v1.1.5 — 2026-05-19（已归档）
...
### 本次变更摘要
- 教程正文与知识关卡区域取消桌面端窄列限制，改为随窗口宽度自适应展示，减少左右大留白。
...
### 本次变更摘要
- 优化触控端教程阅读：章节正文从“卡片内滚动”切换为“整页流式滚动”。
- `Phase1/Phase2` 内部滚动断点统一调整为 `xl`，移动端不再被固定高度容器限制。
- `ScenarioPanel` 与 `AIPanel` 同步断点策略，避免小屏强制双栏导致阅读区域过窄。
- 新增触控端阅读样式，移动端自动解除正文卡片边框/背景包裹。

### 关键文件 SHA-256
| 文件 | SHA-256 |
|------|---------|
| `package.json` | `b7dc987fc51baa18ee8a24e1e9b3f92502067c3ec174389402525dcec648f3bc` |
| `package-lock.json` | `a0e49a5843545d8c610094979f00913e97f3a74c1785987b5075b5c8dc1ed260` |
| `src/components/ModuleDetail.jsx` | `881d0039966800314f6e5beccffcaaff38123edef1405bdf4e33c98edab7ee20` |
| `src/components/ScenarioPanel.jsx` | `17286770b42a63ce32e5ab145b1740d875d7a673437dab7c616d3c88cfabd0d2` |
| `src/components/AIPanel.jsx` | `5f56bac16c9f6ad3ff6cf4142b67ee3e8b4ee367b5630c2b24161a86c8663429` |
| `src/index.css` | `59ebf237f85fcb93c5dab1d5db0e8a86f848b2c62f700a3893d8d7ecc0e7a2d7` |

### 说明
- 本次封板仅覆盖移动端阅读与布局体验，不涉及教程数据与权限逻辑变更。

---

## v1.1.3 — 2026-05-19（已归档）
...
### 说明
- 本次封板聚焦移动端阅读与滚动体验，未改动教程内容数据与权限逻辑。
...
### 说明
- 本次封板聚焦“学习结果可视反馈”增强，未改变教程数据与权限模型。
...
### 本次变更摘要
- 教程体系扩展到 16 模块，新增模块 12/13/14/15 及配套教程内容、检测题、场景数据。
...
### 说明
- 本次封板为“教程扩展 + 架构规范收敛 + 可观测性补齐”，已通过构建与内容校验闸门。
...
- 清除教程内容中的 AI 测试教学：删除模块 07 的“AI 辅助测试”章节，并替换模块 11 相关练习题。
- 同步更新教程说明、学习路线与教辅系统提示，去掉“AI 辅助测试”覆盖描述。
...
### 说明
- 本次封板为“教程 AI 测试内容清理 + 后续待办沉淀”，已通过构建与内容校验闸门。
...
- 教程侧栏与详情页去除“模块 00 / Module 00 / M-00”等编号前缀，标题展示更友好。
...
### 本次变更摘要
- 引入工作台式侧栏布局（`WorkbenchSidebar`），教程导航改为阶段分组 + 模块条目切换。
...
### 说明
- 本次封板为“视觉语义一致性增强”，不改变教程数据结构与业务流程。
...
### 说明
- 本次封板重点为“可观测性 + 校验闸门”增强，目标是提前暴露映射/结构问题，降低教程内容回归成本。
...
| `public/content/00_教程介绍与学习说明.md` | `f85ff9cecdd839c42a87cb3a365ad017b38575ec716b8b2e56df312ec0c994fc` |
...
### 说明
- 本次封板包含界面升级与教程映射修复两类变更，均已通过构建与语法校验。
...
- 增加演示身份 `DEMO_USER(svip)`，教程展示改为按 `effectiveUser` 计算权限。
