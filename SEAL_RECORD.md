...
### 本次变更摘要
- 移动端课程页底部导航改为右下角紧凑悬浮模式，避免全宽导航长期遮挡正文。
...
### 说明
- 本次封板聚焦移动端课程页阅读体验与导航遮挡治理，未改动课程内容数据结构。
...
### 本次变更摘要
- 优化触控端课程阅读：章节正文从“卡片内滚动”切换为“整页流式滚动”。
...
### 说明
- 本次封板仅覆盖移动端阅读与布局体验，不涉及课程数据与权限逻辑变更。
